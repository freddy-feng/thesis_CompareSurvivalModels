...
ggsave(
  filename = "missingness_long.png", plot = missingess.long, device = "png", path = "./figure/", width = 8)
```
...
g <- ggpubr::ggarrange(
  plotlist = list(plots[[1]], plots[[6]]), ncol = 1, widths = 10
)

ggsave(
  filename = "spaghetti_combined.png",
  plot = g, device = "png", path = "./figure/", width = 10, height = 10, bg = "white"
)
```
