...
In this notebook, I copied the example from Kan Li's MFPCCox example on github.
I made minimal changes including adjusting it to use my adapted function_MFPCCox.
...
source("C:/Users/ybfen/Documents/GitHub/thesis_CompareSurvivalModels//function_MFPCCox.R") # Do not recommend to use source! Not robust.
```
...
```{r}
# multivariate FPCA
mFPCA.train = mFPCA(Xi=Xi.train, phi=phi.train, p=3, L=L, I=I) # TO BE GENERALIZED, p is variable
