...
save(folds, file = "output_folds_template.RData")
# -----------------------------------------------------------------------------------
```
...
```{r}
save(folds, file = "./model/model_scenario2_pencal_scaled_seed722.RData")
```
...
```{r}
save(folds.eval, file = "./output/eval_scenario2_pencal_scaled_seed722.RData")
```
