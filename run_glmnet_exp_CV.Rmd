...
TO DO NOTE: according to the Brier score, I need to use summary & survfit with training.x.mat and testing.x.mat to compute the predicted survival probabilities. then, feed the surv prob to the pec and compute the Brier score.
therefore i need to change the folds and folds.eval structure a bit? i need to keep the training.x.mat up to evaluation!

```{r}
testing.dat <- cbind(surv.new[, c("id", "time", "event")], testing.x.mat)
testing.dat
```
